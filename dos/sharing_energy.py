...
for run in tqdm(range(RUNS)):
    ...
    for step in range(STEPS):
        ...
        # values = [target_functions[agent](actions) for agent in range(N_AGENTS)]
        mean_vs = {}
    ...
    for step in range(STEPS):
        ...
        for agent in range(N_AGENTS):
            ...
            trades[agent] = np.clip(trades[agent], 0, 1)
